...
def get_model(n_classes, last_layer='sigmoid', kernel_size = 16, dropout_keep_prob = 0.8):
    ...
    x, y = ResidualUnit(1024, 128, kernel_size=kernel_size,
                        kernel_initializer=kernel_initializer, dropout_keep_prob=dropout_keep_prob)([x, x])
    x, y = ResidualUnit(256, 196, kernel_size=kernel_size,
                        kernel_initializer=kernel_initializer, dropout_keep_prob=dropout_keep_prob)([x, y])
